...
// dbg
int recur_depth = 0;
// #define dbg(x) {++recur_depth; auto x_=x; --recur_depth;
// cerr<<string(recur_depth,
// '\t')<<"\e[91m"<<__func__<<":"<<__LINE__<<"\t"<<#x<<" =
// "<<x_<<"\e[39m"<<endl;}
#define dbg(x)
...
struct Chash {
  ...
  Chash operator+(Chash o) {
    return Chash(h1 + o.h1 % M, h2 + o.h2 % M, h3 + o.h3 % M, h4 + o.h4 % M);
  }
  ...
  bool operator==(Chash o) {
    return (h1 == o.h1 && h2 == o.h2 && h3 == o.h3 && h4 == o.h4);
  }
};
